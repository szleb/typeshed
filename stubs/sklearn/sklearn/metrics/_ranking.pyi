...
def det_curve(
    y_true: ArrayLike, y_score: ArrayLike, pos_label: None | str | Int = None, sample_weight: None | ArrayLike = None
...
def precision_recall_curve(
    y_true: ArrayLike, probas_pred: ArrayLike, *, pos_label: None | str | Int = None, sample_weight: None | ArrayLike = None
) -> tuple[ndarray, ndarray, ndarray]: ...
def roc_curve(
    y_true: ArrayLike,
    y_score: ArrayLike,
