...
def nan_euclidean_distances(
    X: MatrixLike, Y: None | MatrixLike = None, *, squared: bool = False, missing_values: float | int = ..., copy: bool = True
) -> ndarray: ...
def pairwise_distances_argmin_min(
    X: MatrixLike, Y: MatrixLike, *, axis: Int = 1, metric: str | Callable = "euclidean", metric_kwargs: None | dict = None
) -> tuple[ndarray, ndarray]: ...
...
def manhattan_distances(
    X: MatrixLike, Y: None | MatrixLike = None, *, sum_over_features: str | bool = "deprecated"
) -> ndarray: ...
...
def polynomial_kernel(
    X: MatrixLike, Y: None | MatrixLike = None, degree: Int = 3, gamma: None | Float = None, coef0: Float = 1
) -> ndarray: ...
def sigmoid_kernel(X: MatrixLike, Y: None | MatrixLike = None, gamma: None | Float = None, coef0: Float = 1) -> ndarray: ...
