...
def balanced_accuracy_score(
    y_true: ArrayLike, y_pred: ArrayLike, *, sample_weight: None | ArrayLike = None, adjusted: bool = False
) -> float: ...
...
def hamming_loss(
    y_true: MatrixLike | ArrayLike, y_pred: MatrixLike | ArrayLike, *, sample_weight: None | ArrayLike = None
) -> Float: ...
def log_loss(
    y_true: MatrixLike | ArrayLike,
    y_pred: MatrixLike | ArrayLike,
...
def brier_score_loss(
    y_true: ArrayLike, y_prob: ArrayLike, *, sample_weight: None | ArrayLike = None, pos_label: None | str | Int = None
) -> Float: ...
