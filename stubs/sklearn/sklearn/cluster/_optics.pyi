...
from scipy.sparse import issparse as issparse, SparseEfficiencyWarning as SparseEfficiencyWarning
...
def cluster_optics_dbscan(*, reachability: ArrayLike, core_distances: ArrayLike, ordering: ArrayLike, eps: Float) -> ndarray: ...
