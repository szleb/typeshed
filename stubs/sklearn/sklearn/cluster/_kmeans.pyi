...
from ..utils.fixes import threadpool_limits as threadpool_limits, threadpool_info as threadpool_info
...
from ..base import BaseEstimator, ClusterMixin, TransformerMixin, ClassNamePrefixFeaturesOutMixin
...
class _BaseKMeans(ClassNamePrefixFeaturesOutMixin, TransformerMixin, ClusterMixin, BaseEstimator, ABC):
    ...
    def __init__(self, n_clusters: Int, *, init, n_init, max_iter, tol, verbose, random_state) -> None: ...
    def fit_predict(self, X: MatrixLike | ArrayLike, y: Any = None, sample_weight: None | ArrayLike = None) -> ndarray: ...
    def predict(self, X: MatrixLike | ArrayLike, sample_weight: None | ArrayLike = None) -> ndarray: ...
    def fit_transform(self, X: MatrixLike | ArrayLike, y: Any = None, sample_weight: None | ArrayLike = None) -> ndarray: ...
    def transform(self, X: MatrixLike | ArrayLike) -> ndarray: ...
    def score(self, X: MatrixLike | ArrayLike, y: Any = None, sample_weight: None | ArrayLike = None) -> float: ...
...
class KMeans(_BaseKMeans):
    ...
    def fit(
        self: KMeans_Self, X: MatrixLike | ArrayLike, y: Any = None, sample_weight: None | ArrayLike = None
    ) -> KMeans_Self: ...
...
class MiniBatchKMeans(_BaseKMeans):
    ...
    def fit(
        self: MiniBatchKMeans_Self, X: MatrixLike | ArrayLike, y: Any = None, sample_weight: None | ArrayLike = None
