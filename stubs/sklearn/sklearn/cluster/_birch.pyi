...
from ..base import TransformerMixin, ClusterMixin, BaseEstimator, ClassNamePrefixFeaturesOutMixin
...
class _CFNode:
    ...
    def __init__(self, *, threshold: Float, branching_factor: Int, is_leaf: bool, n_features: Int, dtype) -> None: ...
    def append_subcluster(self, subcluster: _CFSubcluster) -> None: ...
    def update_split_subclusters(
        self, subcluster: _CFSubcluster, new_subcluster1: _CFSubcluster, new_subcluster2: _CFSubcluster
    ) -> None: ...
