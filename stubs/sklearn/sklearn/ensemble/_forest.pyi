...
class BaseForest(MultiOutputMixin, BaseEnsemble, metaclass=ABCMeta):
    ...
    def fit(
        self: BaseForest_Self, X: MatrixLike | ArrayLike, y: MatrixLike | ArrayLike, sample_weight: None | ArrayLike = None
    ) -> BaseForest_Self: ...
    @property
...
class RandomForestRegressor(ForestRegressor):
    ...
    def __init__(
        ...
        n_estimators: Int = 100,
        *,
        criterion: Literal["squared_error", "absolute_error", "friedman_mse", "poisson", "squared_error"] = "squared_error",
        max_depth: None | Int = None,
        min_samples_split: float | int = 2,
        min_samples_leaf: float | int = 1,
        min_weight_fraction_leaf: Float = 0.0,
...
class RandomTreesEmbedding(TransformerMixin, BaseForest):
    ...
    def fit(
        self: RandomTreesEmbedding_Self, X: MatrixLike | ArrayLike, y: Any = None, sample_weight: None | ArrayLike = None
    ) -> RandomTreesEmbedding_Self: ...
    def fit_transform(self, X: MatrixLike | ArrayLike, y: Any = None, sample_weight: None | ArrayLike = None) -> spmatrix: ...
