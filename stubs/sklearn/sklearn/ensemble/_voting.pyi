...
class VotingClassifier(ClassifierMixin, _BaseVoting):
    ...
    def fit(
        self: VotingClassifier_Self, X: MatrixLike | ArrayLike, y: ArrayLike, sample_weight: None | ArrayLike = None
...
class VotingRegressor(RegressorMixin, _BaseVoting):
    ...
    def fit(
        self: VotingRegressor_Self, X: MatrixLike | ArrayLike, y: ArrayLike, sample_weight: None | ArrayLike = None
