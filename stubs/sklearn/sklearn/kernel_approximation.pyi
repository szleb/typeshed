...
class PolynomialCountSketch(ClassNamePrefixFeaturesOutMixin, TransformerMixin, BaseEstimator):
    ...
    def fit(
        self: PolynomialCountSketch_Self, X: MatrixLike | ArrayLike, y: None | MatrixLike | ArrayLike = None
...
class RBFSampler(ClassNamePrefixFeaturesOutMixin, TransformerMixin, BaseEstimator):
    ...
    def __init__(
        self, *, gamma: float | str = 1.0, n_components: Int = 100, random_state: RandomState | None | Int = None
    ) -> None: ...
...
class SkewedChi2Sampler(ClassNamePrefixFeaturesOutMixin, TransformerMixin, BaseEstimator):
    ...
    def __init__(
        self, *, skewedness: Float = 1.0, n_components: Int = 100, random_state: RandomState | None | Int = None
    ) -> None: ...
    def fit(self: SkewedChi2Sampler_Self, X: MatrixLike, y: None | MatrixLike | ArrayLike = None) -> SkewedChi2Sampler_Self: ...
    def transform(self, X: MatrixLike) -> ndarray: ...
...
class AdditiveChi2Sampler(TransformerMixin, BaseEstimator):
    ...
    def fit(
        self: AdditiveChi2Sampler_Self, X: MatrixLike, y: None | MatrixLike | ArrayLike = None
