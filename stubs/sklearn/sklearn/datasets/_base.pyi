...
from ..utils import check_random_state as check_random_state, check_pandas_support as check_pandas_support
...
def load_csv_data(
    data_file_name: str, *, data_module: str = ..., descr_file_name: None | str = None, descr_module: str = ...
