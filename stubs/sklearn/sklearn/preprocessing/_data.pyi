...
def scale(
    X: MatrixLike | ArrayLike, *, axis: Int = 0, with_mean: bool = True, with_std: bool = True, copy: bool = True
) -> ndarray | spmatrix: ...
...
class MinMaxScaler(OneToOneFeatureMixin, TransformerMixin, BaseEstimator):
    ...
    def __init__(self, feature_range: tuple[int, int] = ..., *, copy: bool = True, clip: bool = False) -> None: ...
...
def minmax_scale(X: MatrixLike, feature_range: tuple[int, int] = ..., *, axis: Int = 0, copy: bool = True) -> ndarray: ...
...
class QuantileTransformer(OneToOneFeatureMixin, TransformerMixin, BaseEstimator):
    ...
    def fit(self: QuantileTransformer_Self, X: MatrixLike | ArrayLike, y: Series | None = None) -> QuantileTransformer_Self: ...
    def transform(self, X: MatrixLike | ArrayLike) -> ndarray | spmatrix: ...
    def inverse_transform(self, X: MatrixLike | ArrayLike) -> ndarray | spmatrix: ...
