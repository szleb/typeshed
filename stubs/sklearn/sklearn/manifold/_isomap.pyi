...
from scipy.sparse.csgraph import shortest_path as shortest_path, connected_components as connected_components
...
class Isomap(ClassNamePrefixFeaturesOutMixin, TransformerMixin, BaseEstimator):
    ...
    def fit(
        self: Isomap_Self, X: ArrayLike | BallTree | NearestNeighbors | KDTree | csr_matrix, y: Any = None
    ) -> Isomap_Self: ...
