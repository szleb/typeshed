...
class OneVsRestClassifier(MultiOutputMixin, ClassifierMixin, MetaEstimatorMixin, BaseEstimator):
    ...
    def fit(self: OneVsRestClassifier_Self, X: MatrixLike | ArrayLike, y: MatrixLike | ArrayLike) -> OneVsRestClassifier_Self: ...
    def partial_fit(
        self: OneVsRestClassifier_Self, X: MatrixLike | ArrayLike, y: MatrixLike | ArrayLike, classes: None | ArrayLike = None
...
class OneVsOneClassifier(MetaEstimatorMixin, ClassifierMixin, BaseEstimator):
    ...
    def partial_fit(
        self: OneVsOneClassifier_Self, X: MatrixLike, y: ArrayLike, classes: None | ArrayLike = None
