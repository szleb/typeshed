...
class KernelDensity(BaseEstimator):
    ...
    def __init__(
        ...
        *,
        ...
        kernel: Literal["gaussian", "tophat", "epanechnikov", "exponential", "linear", "cosine", "gaussian"] = "gaussian",
    ...
    def fit(self: KernelDensity_Self, X: MatrixLike, y=None, sample_weight: None | ArrayLike = None) -> KernelDensity_Self: ...
