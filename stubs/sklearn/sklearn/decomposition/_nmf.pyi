...
from ..utils import check_random_state as check_random_state, check_array as check_array, gen_batches as gen_batches
...
class NMF(_BaseNMF):
    ...
    def fit_transform(
        self, X: MatrixLike | ArrayLike, y: Any = None, W: None | MatrixLike = None, H: None | ArrayLike = None
    ) -> ndarray: ...
...
class MiniBatchNMF(_BaseNMF):
    ...
    def transform(self, X: MatrixLike | ArrayLike) -> ndarray: ...
    def partial_fit(
        self: MiniBatchNMF_Self, X: MatrixLike | ArrayLike, y: Any = None, W: None | MatrixLike = None, H: None | ArrayLike = None
    ) -> MiniBatchNMF_Self: ...
