...
class BaseSGDRegressor(RegressorMixin, BaseSGD):
    ...
    def partial_fit(
        self: BaseSGDRegressor_Self, X: MatrixLike, y: ArrayLike, sample_weight: None | ArrayLike = None
...
class SGDOneClassSVM(BaseSGD, OutlierMixin):
    ...
    def partial_fit(
        self: SGDOneClassSVM_Self, X: MatrixLike, y: Any = None, sample_weight: None | ArrayLike = None
    ) -> SGDOneClassSVM_Self: ...
    def fit(
