...
from ..base import BaseEstimator, MetaEstimatorMixin, RegressorMixin, clone as clone, MultiOutputMixin
...
from ..utils import check_random_state as check_random_state, check_consistent_length as check_consistent_length
...
class RANSACRegressor(MetaEstimatorMixin, RegressorMixin, MultiOutputMixin, BaseEstimator):
    ...
    def fit(
        self: RANSACRegressor_Self, X: MatrixLike | ArrayLike, y: MatrixLike | ArrayLike, sample_weight: None | ArrayLike = None
