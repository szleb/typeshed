...
from ..preprocessing import LabelEncoder as LabelEncoder, LabelBinarizer as LabelBinarizer
...
class LogisticRegression(LinearClassifierMixin, SparseCoefMixin, BaseEstimator):
    ...
    def fit(
        self: LogisticRegression_Self, X: MatrixLike | ArrayLike, y: ArrayLike, sample_weight: None | ArrayLike = None
...
class LogisticRegressionCV(LogisticRegression, LinearClassifierMixin, BaseEstimator):
    ...
    def fit(
        self: LogisticRegressionCV_Self, X: MatrixLike | ArrayLike, y: ArrayLike, sample_weight: None | ArrayLike = None
