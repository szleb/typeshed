...
class QuantileRegressor(LinearModel, RegressorMixin, BaseEstimator):
    ...
    def __init__(
        ...
        *,
        ...
        solver: Literal["highs-ds", "highs-ipm", "highs", "interior-point", "revised simplex", "warn"] = "warn",
        solver_options: None | dict = None,
    ) -> None: ...
    def fit(
        self: QuantileRegressor_Self, X: MatrixLike | ArrayLike, y: ArrayLike, sample_weight: None | ArrayLike = None
