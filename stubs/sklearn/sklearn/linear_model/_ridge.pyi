...
class Ridge(MultiOutputMixin, RegressorMixin, _BaseRidge):
    ...
    def fit(
        self: Ridge_Self, X: coo_matrix | MatrixLike, y: MatrixLike | ArrayLike, sample_weight: float | None | ArrayLike = None
    ) -> Ridge_Self: ...
...
class RidgeClassifier(_RidgeClassifierMixin, _BaseRidge):
    ...
    def fit(
        self: RidgeClassifier_Self, X: MatrixLike, y: ArrayLike, sample_weight: float | None | ArrayLike = None
...
class _RidgeGCV(LinearModel):
    ...
    def fit(
        self: _RidgeGCV_Self, X: MatrixLike, y: MatrixLike | ArrayLike, sample_weight: float | None | ArrayLike = None
    ) -> _RidgeGCV_Self: ...
...
class RidgeCV(MultiOutputMixin, RegressorMixin, _BaseRidgeCV):
    ...
    def fit(
        self: RidgeCV_Self, X: ArrayLike | DataFrame, y: MatrixLike | ArrayLike, sample_weight: float | None | ArrayLike = None
    ) -> RidgeCV_Self: ...
...
class RidgeClassifierCV(_RidgeClassifierMixin, _BaseRidgeCV):
    ...
    def fit(
        self: RidgeClassifierCV_Self, X: ArrayLike, y: ArrayLike, sample_weight: float | None | ArrayLike = None
