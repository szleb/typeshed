...
class BaseCrossValidator(metaclass=ABCMeta):
    def split(
        self, X: list[str] | MatrixLike, y: None | ArrayLike = None, groups: None | ArrayLike = None
    ) -> Iterator[tuple[ndarray, ndarray]]: ...
    @abstractmethod
    def get_n_splits(self, X=None, y=None, groups=None) -> None: ...
...
class LeavePOut(BaseCrossValidator):
    ...
    def get_n_splits(self, X: MatrixLike, y: Any = None, groups: Any = None) -> None: ...
...
class KFold(_BaseKFold):
    def __init__(self, n_splits: Int = 5, *, shuffle: bool = False, random_state: RandomState | None | Int = None) -> None: ...
...
class StratifiedGroupKFold(_BaseKFold):
    def __init__(self, n_splits: Int = 5, shuffle: bool = False, random_state: None | RandomState | int = None) -> None: ...

class TimeSeriesSplit(_BaseKFold):
    def __init__(
        self, n_splits: Int = 5, *, max_train_size: None | Int = None, test_size: None | Int = None, gap: Int = 0
    ) -> None: ...
    def split(
...
class LeaveOneGroupOut(BaseCrossValidator):
    ...
    def split(self, X: MatrixLike, y: None | ArrayLike = None, groups: None | ArrayLike = None) -> None: ...
...
class _RepeatedSplits(metaclass=ABCMeta):
    def __init__(self, cv: Callable, *, n_repeats: Int = 10, random_state: RandomState | None | Int = None, **cvargs) -> None: ...
    def split(
        self, X: MatrixLike, y: None | ArrayLike = None, groups: None | ArrayLike = None
    ) -> Iterator[tuple[ndarray, ndarray]]: ...
    def get_n_splits(self, X: Any = None, y: Any = None, groups: None | ArrayLike = None) -> int: ...
...
class RepeatedKFold(_RepeatedSplits):
    def __init__(self, *, n_splits: Int = 5, n_repeats: Int = 10, random_state: RandomState | None | Int = None) -> None: ...
...
def check_cv(
    cv: Iterable | int | BaseShuffleSplit | BaseCrossValidator = 5, y: None | ArrayLike = None, *, classifier: bool = False
) -> BaseCrossValidator: ...
