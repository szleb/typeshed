...
class DummyClassifier(MultiOutputMixin, ClassifierMixin, BaseEstimator):
    ...
    def fit(
        self: DummyClassifier_Self, X: MatrixLike, y: MatrixLike | ArrayLike, sample_weight: None | ArrayLike = None
    ...
    def score(self, X: None | MatrixLike, y: MatrixLike | ArrayLike, sample_weight: None | ArrayLike = None) -> float: ...
...
class DummyRegressor(MultiOutputMixin, RegressorMixin, BaseEstimator):
    ...
    def fit(
        self: DummyRegressor_Self, X: MatrixLike, y: MatrixLike | ArrayLike, sample_weight: None | ArrayLike = None
    ) -> DummyRegressor_Self: ...
