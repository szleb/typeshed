...
def assert_all_finite(
    X: MatrixLike | ArrayLike, *, allow_nan: bool = False, estimator_name: None | str = None, input_name: str = ""
) -> None: ...
def as_float_array(
...
def check_symmetric(
    array: coo_matrix | MatrixLike | ArrayLike, *, tol: Float = 1e-10, raise_warning: bool = True, raise_exception: bool = False
) -> ndarray | spmatrix: ...
def check_is_fitted(
