...
from ..metrics.pairwise import rbf_kernel as rbf_kernel, linear_kernel as linear_kernel, pairwise_distances as pairwise_distances
...
from ..model_selection import train_test_split as train_test_split, ShuffleSplit as ShuffleSplit
...
from ..feature_selection import SelectKBest as SelectKBest, SelectFromModel as SelectFromModel
...
def parametrize_with_checks(estimators: Sequence[BaseEstimator]) -> MarkDecorator | parameterize: ...
def check_estimator(
    estimator: None | BaseEstimator = None, generate_only: bool = False, Estimator: str | BaseEstimator = "deprecated"
) -> Generator: ...
