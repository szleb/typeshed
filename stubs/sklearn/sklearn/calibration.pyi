...
class CalibratedClassifierCV(ClassifierMixin, MetaEstimatorMixin, BaseEstimator):
    ...
    def fit(
        self: CalibratedClassifierCV_Self, X: MatrixLike, y: ArrayLike, sample_weight: None | ArrayLike = None, **fit_params
...
class CalibrationDisplay:
    ...
    def plot(self, *, ax: None | Axes = None, name: None | str = None, ref_line: bool = True, **kwargs) -> CalibrationDisplay: ...
    @classmethod
    def from_estimator(
        cls,
        estimator: BaseEstimator,
