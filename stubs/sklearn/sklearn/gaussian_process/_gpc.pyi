...
from ..multiclass import OneVsRestClassifier as OneVsRestClassifier, OneVsOneClassifier as OneVsOneClassifier
...
_BinaryGaussianProcessClassifierLaplace_Self = TypeVar(
    "_BinaryGaussianProcessClassifierLaplace_Self", bound="_BinaryGaussianProcessClassifierLaplace"
)
...
class _BinaryGaussianProcessClassifierLaplace(BaseEstimator):
    ...
    def fit(
        self: _BinaryGaussianProcessClassifierLaplace_Self, X: MatrixLike | ArrayLike, y: ArrayLike
    ) -> _BinaryGaussianProcessClassifierLaplace_Self: ...
    def predict(self, X: MatrixLike | ArrayLike) -> ndarray: ...
    def predict_proba(self, X: MatrixLike | ArrayLike) -> ndarray: ...
    def log_marginal_likelihood(
        self, theta: None | ArrayLike = None, eval_gradient: bool = False, clone_kernel: bool = True
