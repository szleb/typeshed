...
from .link import BaseLink, Interval, LogitLink as LogitLink, LogLink as LogLink, MultinomialLogit as MultinomialLogit
...
class BaseLoss:
    ...
    def in_y_pred_range(self, y: ArrayLike) -> None: ...
    def loss(
        self,
        y_true: ArrayLike,
    ...
    def constant_to_optimal_zero(self, y_true, sample_weight=None) -> None: ...
    def init_gradient_and_hessian(
        self, n_samples: Int, dtype: type[Float] | Float = ..., order: Literal["C", "F", "F"] = "F"
    ) -> tuple[ndarray, ndarray]: ...
...
class AbsoluteError(BaseLoss):
    ...
    def __init__(self, sample_weight=None) -> None: ...
    def fit_intercept_only(self, y_true, sample_weight=None) -> None: ...
...
class HalfMultinomialLoss(BaseLoss):
    ...
    def in_y_true_range(self, y: ArrayLike) -> None: ...
    def fit_intercept_only(self, y_true, sample_weight=None) -> None: ...
