...
def inplace_tanh(X: MatrixLike) -> None: ...
def inplace_relu(X: MatrixLike) -> None: ...
def inplace_softmax(X: MatrixLike) -> None: ...

ACTIVATIONS: dict = ...

def inplace_identity_derivative(Z: MatrixLike, delta: MatrixLike) -> None: ...
def inplace_logistic_derivative(Z: MatrixLike, delta: MatrixLike) -> None: ...
def inplace_tanh_derivative(Z: MatrixLike, delta: MatrixLike) -> None: ...
