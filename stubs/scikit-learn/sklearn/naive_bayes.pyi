...
class GaussianNB(_BaseNB):
    ...
    def fit(self: GaussianNB_Self, X: MatrixLike, y: ArrayLike, sample_weight: None | ArrayLike = None) -> GaussianNB_Self: ...
    def partial_fit(
...
class _BaseDiscreteNB(_BaseNB):
    ...
    def __init__(self, alpha: Float = 1.0, fit_prior: bool = True, class_prior=None, force_alpha: str = "warn") -> None: ...
    def partial_fit(
    ...
    def fit(
        self: _BaseDiscreteNB_Self, X: MatrixLike | ArrayLike, y: ArrayLike, sample_weight: None | ArrayLike = None
...
class CategoricalNB(_BaseDiscreteNB):
    ...
    def fit(
        self: CategoricalNB_Self, X: MatrixLike | ArrayLike, y: ArrayLike, sample_weight: None | ArrayLike = None
    ) -> CategoricalNB_Self: ...
    def partial_fit(
