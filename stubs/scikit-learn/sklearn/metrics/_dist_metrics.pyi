...
class DistanceMetric:
    ...
    def dist(self, x1, x2, size) -> None: ...
    def rdist(self, x1, x2, size) -> None: ...
    def pdist(self, X, D) -> int: ...
    def cdist(self, X, Y, D) -> int: ...
    def dist_csr(self, x1_data, x1_indices, x2_data, x2_indices, x1_start, x1_end, x2_start, x2_end, size) -> None: ...
    def rdist_csr(self, x1_data, x1_indices, x2_data, x2_indices, x1_start, x1_end, x2_start, x2_end, size) -> None: ...
