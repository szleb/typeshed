...
class _BaseScorer:
    ...
    def __call__(
        self, estimator: Any, X: MatrixLike | ArrayLike, y_true: ArrayLike, sample_weight: None | ArrayLike = None
    ) -> Float: ...
...
def check_scoring(
    estimator: BaseEstimator, scoring: _PredictScorer | None | str | Callable = None, *, allow_none: bool = False
) -> Callable: ...
def make_scorer(
    score_func: Callable, *, greater_is_better: bool = True, needs_proba: bool = False, needs_threshold: bool = False, **kwargs
) -> Callable: ...
...
def positive_likelihood_ratio(y_true, y_pred) -> None: ...
def negative_likelihood_ratio(y_true, y_pred) -> None: ...
