...
class GaussianProcessRegressor(MultiOutputMixin, RegressorMixin, BaseEstimator):
    ...
    def fit(
        self: GaussianProcessRegressor_Self, X: MatrixLike | ArrayLike, y: MatrixLike | ArrayLike
    ) -> GaussianProcessRegressor_Self: ...
    def predict(
        self, X: MatrixLike | ArrayLike, return_std: bool = False, return_cov: bool = False
    ) -> ndarray | tuple[ndarray, ndarray, ndarray] | tuple[ndarray, ndarray]: ...
    def sample_y(self, X: MatrixLike | ArrayLike, n_samples: Int = 1, random_state: RandomState | None | Int = 0) -> ndarray: ...
