...
class StackingClassifier(ClassifierMixin, _BaseStacking):
    ...
    def fit(
        self: StackingClassifier_Self, X: MatrixLike | ArrayLike, y: ArrayLike, sample_weight: None | ArrayLike = None
...
class StackingRegressor(RegressorMixin, _BaseStacking):
    ...
    def fit(
        self: StackingRegressor_Self, X: MatrixLike | ArrayLike, y: ArrayLike, sample_weight: None | ArrayLike = None
