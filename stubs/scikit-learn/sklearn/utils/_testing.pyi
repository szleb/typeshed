...
def assert_no_warnings(func, *args, **kw) -> None: ...
...
def assert_raise_message(
    exceptions: tuple[Exception, ...] | Exception, message: str, function: Callable, *args, **kwargs
) -> None: ...
def assert_allclose(
    actual: ArrayLike,
    desired: ArrayLike,
...
def assert_allclose_dense_sparse(
    x: MatrixLike | ArrayLike, y: MatrixLike | ArrayLike, rtol: Float = 1e-07, atol: Float = 1e-9, err_msg: str = ""
) -> None: ...
def set_random_state(estimator: Any, random_state: RandomState | None | Int = 0) -> None: ...
...
def create_memmap_backed_data(data, mmap_mode: str = "r", return_folder: bool = False, aligned: bool = False) -> None: ...
def check_docstring_parameters(func: Callable, doc: None | str = None, ignore: Sequence | None = None) -> ndarray: ...
def assert_run_python_script(source_code: str, timeout: Int = 60) -> None: ...
def raises(
    expected_exc_type, match: None | str | Sequence[str] = None, may_pass: bool = False, err_msg: None | str = None
) -> None: ...
