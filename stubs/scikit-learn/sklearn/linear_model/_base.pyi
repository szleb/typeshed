...
def make_dataset(
    X: MatrixLike, y: ArrayLike, sample_weight: ArrayLike, random_state: None | Int | RandomState = None
...
class LinearRegression(MultiOutputMixin, RegressorMixin, LinearModel):
    ...
    def __init__(
        self, *, fit_intercept: bool = True, copy_X: bool = True, n_jobs: None | Int = None, positive: bool = False
    ) -> None: ...
    def fit(
        self: LinearRegression_Self, X: MatrixLike | ArrayLike, y: MatrixLike | ArrayLike, sample_weight: None | ArrayLike = None
