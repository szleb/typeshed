...
class BaseDecisionTree(MultiOutputMixin, BaseEstimator, metaclass=ABCMeta):
    ...
    def cost_complexity_pruning_path(
        self, X: MatrixLike | ArrayLike, y: MatrixLike | ArrayLike, sample_weight: None | ArrayLike = None
    ) -> Bunch: ...
    @property
...
class DecisionTreeRegressor(RegressorMixin, BaseDecisionTree):
    ...
    def __init__(
        self,
        *,
        criterion: Literal["squared_error", "friedman_mse", "absolute_error", "poisson", "squared_error"] = "squared_error",
        splitter: Literal["best", "random", "best"] = "best",
        max_depth: None | Int = None,
        min_samples_split: float | int = 2,
        min_samples_leaf: float | int = 1,
