...
class SelectFromModel(MetaEstimatorMixin, SelectorMixin, BaseEstimator):
    ...
    def fit(self: SelectFromModel_Self, X: MatrixLike, y: None | ArrayLike = None, **fit_params) -> SelectFromModel_Self: ...
    @property
    def threshold_(self) -> float: ...
    def partial_fit(
        self: SelectFromModel_Self, X: MatrixLike, y: None | ArrayLike = None, **fit_params
