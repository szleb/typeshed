...
def make_friedman1(
    n_samples: Int = 100, n_features: Int = 10, *, noise: Float = 0.0, random_state: RandomState | None | Int = None
) -> tuple[ndarray, ndarray]: ...
def make_friedman2(
    n_samples: Int = 100, *, noise: Float = 0.0, random_state: RandomState | None | Int = None
) -> tuple[ndarray, ndarray]: ...
def make_friedman3(
    n_samples: Int = 100, *, noise: Float = 0.0, random_state: RandomState | None | Int = None
) -> tuple[ndarray, ndarray]: ...
...
def make_sparse_uncorrelated(
    n_samples: Int = 100, n_features: Int = 10, *, random_state: RandomState | None | Int = None
) -> tuple[ndarray, ndarray]: ...
...
def make_swiss_roll(
    n_samples: Int = 100, *, noise: Float = 0.0, random_state: RandomState | None | Int = None, hole: bool = False
) -> tuple[ndarray, ndarray]: ...
def make_s_curve(
    n_samples: Int = 100, *, noise: Float = 0.0, random_state: RandomState | None | Int = None
) -> tuple[ndarray, ndarray]: ...
